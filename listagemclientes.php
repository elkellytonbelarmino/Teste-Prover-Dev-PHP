...
<div class="container-fluid" style="margin-top: 30px;">
    <div class="container col-md-12" align="center">
        ...
        <thead class="thead-dark">
            ...
            <thead class="thead-dark">
            <?php while($linhas = mysqli_fetch_array($query0)){ ?>
            <tr>
                <td><?php echo $linhas["id"]; ?></td>
                <td><?php echo $linhas["nome"]; ?></td>
                <td><?php echo $linhas["telefone"]; ?></td>
                <td><?php echo $linhas["email"]; ?></td>
                <td><a href="editarcliente.php?id=<?php echo $linhas['id'] ?>" class="btn btn-warning">Editar</a></td>
                <td><form method="post">
...
<!-- Script de Exclusão de Vendas/Clientes -->
...
if(isset($_POST['excluir']) && filter_input(INPUT_POST, 'excluir', FILTER_VALIDATE_INT) !== false){
    ...
    if (mysqli_query($conn, $sql2)) {
                    echo "<script>window.location='listagemclientes.php';alert('Cliente excluído com sucesso!');</script>";
                    
                } 
                else {
                    echo "<script>window.location='listagemclientes.php';alert('ERRO! Não foi possível excluir o cliente.');</script>";                    
   }

}
   mysqli_close($conn);
?>
<!-- Fim do Script de Exclusão de Vendas/Clientes -->
